...
@Singleton
class FakeAppRemoteDataSource @Inject constructor() : AppRemoteDataSource {
    ...
    private val financeReports = mutableListOf(
        FinanceReportDto(
            id = "finance-1",
    ...
    private val paymentObligations = mutableListOf(
