...
object AppConstants {
    ...
    const val FIRESTORE_COLLECTION_WORSHIP_TEMPLATES = "worship_templates"
    ...
    const val FIRESTORE_FIELD_ID = "id"
    ...
    const val FIRESTORE_FIELD_PROGRAM_ITEMS = "program_items"
    const val FIRESTORE_FIELD_TEMPLATE_ITEMS = "template_items"
    const val FIRESTORE_FIELD_TENANT_ID = "tenant_id"
    const val FIRESTORE_FIELD_ORDER_INDEX = "order_index"
    const val FIRESTORE_FIELD_CONTENT = "content"
    const val FIRESTORE_FIELD_LEADER = "leader"
    const val FIRESTORE_FIELD_TYPE = "type"
    const val FIRESTORE_FIELD_TEMPLATE_ID = "template_id"
    const val FIRESTORE_FIELD_EVENT_ID = "event_id"
